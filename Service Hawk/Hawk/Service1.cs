...
namespace Hawk
{
    public partial class Service1 : ServiceBase
    {
        ...
        {
            InitializeComponent();
            s = new System.ServiceProcess.ServiceController("Service1");//service1 is nothing just dummy
            service.Add(s);
        }
        ...
        private void sendNotificarion(String appAdd, String password, String adminAdd, String Servicename, String Host, int port)
        {
            ...
            {
                client.Send(mail);
                help.WriteErrorlog("ErrorMessage is sent to Admin Email");
            }
            catch (SmtpException e)
            {

                help.WriteErrorlog(e.InnerException.Message);
            }
        }
